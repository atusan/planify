...
var CalendarCell = function CalendarCell(_ref) {
  var children = _ref.children,
      ...
      today = _ref.today,
      otherProps = _objectWithoutPropertiesLoose(_ref, ["children", "end", "hovered", "inRange", "inverted", "nextMonth", "prevMonth", "selectable", "selected", "start", "today"]);
...
var TodayButton = function TodayButton(_ref) {
  var ariaLabel = _ref['aria-label'],
      ...
      otherProps = _objectWithoutPropertiesLoose(_ref, ["aria-label", "children", "end", "hovered", "inRange", "nextMonth", "prevMonth", "selectable", "selected", "start", "today"]);
...
var Calendar = function Calendar(_ref) {
  ...
  var _getRootProps = getRootProps(),
      ...
      rootProps = _objectWithoutPropertiesLoose(_getRootProps, ["ref"]);
  ...
  return React.createElement(Ref, {
    innerRef: rootRef
  }, React.createElement(Segment, Object.assign({}, rootProps, {
    inverted: inverted,
...
var CustomInput = /*#__PURE__*/React.forwardRef(function (props, ref) {
  var clearIcon = props.clearIcon,
      ...
      value = props.value,
      rest = _objectWithoutPropertiesLoose(props, ["clearIcon", "icon", "isClearIconVisible", "label", "onClear", "onFocus", "required", "value"]);

  return React.createElement(Form.Field, {
    required: required
  }, label && React.createElement("label", {
    htmlFor: rest.id
  }, label), React.createElement(Input, Object.assign({}, rest, {
    ref: ref,
    required: required,
...
var SemanticDatepicker = /*#__PURE__*/function (_React$Component) {
  ...
  function SemanticDatepicker() {
    ...
    _this.focusOnInput = function () {
      ...
      if ((_this$inputRef = _this.inputRef) === null || _this$inputRef === void 0 ? void 0 : _this$inputRef.current) {
        // @ts-ignore
